...
public class DesEditDialog extends JDialog {
	 ...
	 * Create the dialog.
	 */
	public DesEditDialog(final String lpEditName, String lpEditTags) {
					...
					public void actionPerformed(ActionEvent ev) {
						try {
							...
							if (textArea.equals(null) && textField.equals(null)) {
								...
								Stat.executeUpdate("UPDATE letsplaydes SET name2='"
										+ lpName
										+ "',lpdes='"
										+ lpText
										+ "' WHERE name2='" + lpEditName + "'");
