...
public class TagsAddDialog extends JDialog {
	...
	public TagsAddDialog() {
		...
		lblTags.setBounds(10, 57, 182, 14);
						...
						try {
							...
							if (textArea.getText().equals("")
								...
								JOptionPane.showMessageDialog(null,
										"Missing Name and Tags",
										"Missing Info!",
										JOptionPane.ERROR_MESSAGE);
							} else {
								PreparedStatement prep = conn
										.prepareStatement("Insert into letsplaytags (name,lptags) values (?,?);");
